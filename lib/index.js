...
exports.parseGeneral = BBPromise.method(function(chtml){
	var clutteredMeta = {
		...
		// prev: chtml('link[rel=prev" i]').map(function(i, e) {
		// 	return {
		// 		href: e.attribs.href,
		...
		next: chtml('link[rel="next" i]').map(function(i, e) {
			return e.attribs;
		}).get(),

		first: chtml('link[rel="first" i]').map(function(i, e) {
			return e.attribs;
		}).get(),

		last: chtml('link[rel="last" i]').map(function(i, e) {
			return e.attribs;
		}).get(),

		// prev: chtml('link[rel=prev i]').first().attr('href'), //prev link <link rel="prev" href="">
		// next: chtml('link[rel=next i]').first().attr('href'), //next link <link rel="next" href="">
		description: chtml('meta[name=description i]').attr('content'), //meta description <meta name ="description" content="">
		publisher: chtml('meta[name=publisher i]').first().attr('publisher'),
		relPublisher: chtml('link[rel="publisher" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		...
		manifest: chtml('link[rel="manifest" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		}).get(),
		keywords: chtml('meta[name=keywords i]').first().attr('content'),
		atom: chtml('link[type="application/atom+xml" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		}).get(),
		rdf: chtml('link[type="application/rdf+xml" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		}).get(),
		rss: chtml('link[type="application/rss+xml" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		}).get(),
		xml: chtml('link[type="text/xml" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		}).get(),
		json: chtml('link[type="application/json" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		}).get(),
		search: chtml('link[type="application/opensearchdescription+xml" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		}).get(),
		color: chtml('meta[name="theme-color" i], meta[name="msapplication-TileColor" i]').attr('content'),
		mention: chtml('link[rel="webmention" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		}).get(),
		hub: chtml('link[rel="hub" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		}).get(),
		salmon: chtml('link[rel="salmon" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
...
// <link rel="alternate" type="text/xml+oembed" />
		...
		oembedXML: chtml('link[type="text/xml+oembed" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
...
// <link rel="alternate" type="application/json+oembed" />
		...
		oembedJSON: chtml('link[type="application/json+oembed" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		...
		pdf: chtml('link[type="application/pdf" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		...
		epub: chtml('link[type="application/epub" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		...
		epubZip: chtml('link[type="application/epub+zip" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		...
		bookmark: chtml('link[rel="bookmark" i]').map(function(i, e) {
			return {
				href: e.attribs.href,
				title: e.attribs.title
			};
		...
		original: chtml('link[rel="original" i]').map(function(i, e) {
			return e.attribs;
		}).get(),

		memento: chtml('link[rel="memento" i]').map(function(i, e) {
			return e.attribs;
		}).get(),

		timemap: chtml('link[rel="timemap" i]').map(function(i, e) {
			return e.attribs;
		}).get(),

		timegate: chtml('link[rel="timegate" i]').map(function(i, e) {
			return e.attribs;
		}).get(),

		webpub: chtml('link[type="application/webpub+json" i]').map(function(i, e) {
			return e.attribs;
		}).get(),

		publication: chtml('link[rel="publication" i]').map(function(i, e) {
			return e.attribs;
		}).get(),

		wiki: chtml('link[rel="alternate" type="application/wiki" i]').map(function(i, e) {
			return e.attribs;
		}).get(),
		xwiki: chtml('link[rel="alternate" type="application/x-wiki" i]').map(function(i, e) {
			return e.attribs;
		}).get(),

		'chrome-webstore-item': chtml('link[rel="chrome-webstore-item" i]').map(function(i, e) {
			return e.attribs;
		}).get(),
